  ...
  render(){
    return(
     <form onSubmit={this.handleSubmit} className="artiList-container">
       <div className="artiList-searchDiv mdl-textfield mdl-js-textfield ">
         <label className="mdl-button mdl-js-button mdl-button--icon artiList-searchIcon" for="search">
         ...
         <div>
           ...
           />
           <label className="mdl-textfield__label artiList-searchLabel" for="sample-expandable">Search By Title</label>
         </div>
       </div>
     </form>
    );
